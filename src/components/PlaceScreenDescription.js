        ...
        return (
            <View>
                <View style={{ width: "100%" }}>
                    <Text numberOfLines={5} style={{ margin: 10 }}>{this.props.place.about}</Text>
                </View>
                ...
                <View style={styles.place_section}>
                    <View style={{ width: "50%", alignItems: "center" }}>
                        ...
                        <Text>Позвонить</Text>
                        <Text>{this.props.place.phone}</Text>
                    </View>
                    <View style={{ width: "50%", alignItems: "center" }}>
                ...
                <View style={styles.place_section}>
                    <View>
                        ...
                        <Text style={{ fontStyle: "italic" }}>Время работы, Wi-fi, парковка</Text>
                    </View>
                    <View>
                ...
                <View style={styles.place_section}>
                    <View style={{ width: "70%" }}>
                        <Text style={{ fontWeight: "bold" }}>{this.props.place.statios}</Text>
                        <Text style={{ fontStyle: "italic" }}>{this.props.place.adress}</Text>
                    </View>
                    <View style={{ width: "30%" }}>
                        <MapView
                            style={styles.map}
